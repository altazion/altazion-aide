...
Si vous optez pour une segmentation pour le client différente de celle de votre système historique, Altazion permet d'intégrer cette dernière avec un système de correspondance ou de double hierarchie.
...
_Un exemple : une entreprise de vente d'imprimantes professionnelles a une segmentation interne par caractéristiques et termes très techniques mais souhaite vendre en ligne avec une approche basée sur l'usage, une imprimante poura être de la famille "copieur jet d'encre format a4" et dans le segment client "imprimante pour PME à usage modéré._
