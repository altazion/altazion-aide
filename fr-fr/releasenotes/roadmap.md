...
<div class="item">
<h3>3 - Les disponibilités et la référence produit ajoutées aux points API de suggestions</h3>
...
<div class="item">
<h3>6 - Pouvoir remplacer un fichier dans une médiation non terminée (en cas d'erreur par exemple)</h3>
</div>
</div>
...
<div class="item">
<h3>3 - Optimisations du module Orchestrator </h3>
</div>
<div class="item">
...
<div class="item">
<h3>6 - Migration .net standard & .net 6.0 pour les solutions OnPremise </h3>
</div>
</div>
<h2>A l'étude</h2>
<div id="etude">
...
<div class="item">
<h3>2 - Configuration dans l'interface graphique des workflows de préparation Orchestrator</h3>
</div>
<div class="item">
